...
//		DES des = new DES();
//		System.out.println(des.authcode("d8fPhfd9JkW99p8aqhtVIA==","ENCODE","0102030405060708"));//加密
//		System.out.println(des.authcode("wewweewewew=","DECODE","0102030405060708"));//解密
//	}
}